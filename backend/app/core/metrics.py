...
class MetricsCalculator:
    ...
    def calculate_statistics_density(content: str) -> Dict:
        ...
        return {
            ...
            'recommendation': self._get_statistics_recommendation(score, stat_count, word_count)
        }
    ...
    def calculate_quotation_authority(content: str) -> Dict:
        ...
        return {
            ...
            'recommendation': self._get_quotation_recommendation(score, quotes_found)
        }
    ...
    def calculate_fluency_score(content: str) -> Dict:
        ...
        return {
            ...
            'recommendation': self._get_fluency_recommendation(score, avg_length, transition_count)
        }
    ...
    def calculate_relevance_score(query: str, content: str) -> Dict:
        ...
        return {
            ...
            'recommendation': self._get_relevance_recommendation(score, keyword_overlap)
        }
